			...
			for (var i = 1; i <= 5; i++) {
				...
				if (i == 1){
					...
					Arreglo = {"cedula":c1[0], "nombre":c1[1], 
						"tipo":"OposicionSuplenteCpec", "apellido":c1[2], 
		        ...
		        if (i == 2){
					...
					Arreglo = {"cedula":c2[0], "nombre":c2[1], 
						"tipo":"OposicionSuplenteCpec", "apellido":c2[2], 
		        ...
		        if (i == 3){
					...
					Arreglo = {"cedula":c3[0], "nombre":c3[1], 
						"tipo":"OposicionSuplenteCpec", "apellido":c3[2], 
		        ...
		        if (i == 4){
					...
					Arreglo = {"cedula":c4[0], "nombre":c4[1], 
						"tipo":"OposicionSuplenteCpec", "apellido":c4[2], 
		        ...
		        if (i == 5){
					...
					Arreglo = {"cedula":c5[0], "nombre":c5[1], 
						"tipo":"OposicionSuplenteCpec", "apellido":c5[2], 
